...
export default function Navbar() {
 ...
 <h1 className='text-2xl text-green-600 font-bold'>MixMaster</h1>
    ...
    <div className="flex items-center space-x-2">
      ...
      <Link to='/about' className="capitalize font-normal tracking-widest text-lg px-2 py-1 transition-colors duration-300 hover:text-green-500">
        ...
        <Link to='/form' className="capitalize font-normal tracking-widest text-lg px-2 py-1 transition-colors duration-300 hover:text-green-500">
    form
      </Link>
    </div>
